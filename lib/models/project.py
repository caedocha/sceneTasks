...
class Project(ModelBase):
	...
	def create(self):
		""" Creates a project in a maya directory, includes default directories """
		try:
			os.makedirs(os.path.join(self.directories().root(), paths.SCENES_PATH, 'assets', 'defaults'))
			os.makedirs(os.path.join(self.directories().root(), paths.SCENES_PATH, 'workshops', 'defaults'))
	...
	def delete(self):
		...
		try:
			...
			shutil.rmtree(os.path.join(self.directories().root(), paths.SCENES_PATH, 'assets'))
			shutil.rmtree(os.path.join(self.directories().root(), paths.SCENES_PATH, 'workshops'))
		except IOError, ex:
			raise
